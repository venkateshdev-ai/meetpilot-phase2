...
// Billing/invoicing for paid or external room & desk usage. Real implementation
// charges via Stripe Billing (see README) — this view mirrors the resulting
// invoice objects and is gated behind the "billing:view" permission.
export default function BillingPage() {
  ...
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-slate-400">Invoices for paid room and desk usage.</p>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <Card className="text-center">
          <div className="text-2xl font-bold text-warning">₹{totals.outstanding.toLocaleString()}</div>
          <div className="text-xs text-slate-500">Outstanding</div>
        </Card>
        <Card className="text-center">
          <div className="text-2xl font-bold text-slate-400">₹{totals.draft.toLocaleString()}</div>
